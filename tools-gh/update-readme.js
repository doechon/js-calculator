...
if (readme.includes("<!-- AUTOGENERATED_SECTION -->")) {
    const startMarker = "<!-- AUTOGENERATED_SECTION -->"
    const endMarker = "<!-- AUTOGENERATED_SECTION -->"
    ...
    console.log("❌ Маркер <!-- AUTOGENERATED_SECTION --> не найден")
    process.exit(1)
}
